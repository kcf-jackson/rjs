# Example 4. This example explores the use of multiple canvas with p5.js.
...
my_html %<>% add_style("#ctl_1, #ctl_2, #ctl_3 {padding-bottom: 8px;}")
my_html %<>% add_script_from_file("example_4.js")

r_fun <- function(msg) { msg }
